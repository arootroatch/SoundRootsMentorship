    ...
    <section className={`${styles.about}`}>
      <div className={styles.container}>
        ...
        <p className={styles.p}>
          I see it all the time: recent graduates of audio programs, many of
          them with Bachelor's degrees and student loan debt, apply for a job
          only to discover that their education didn't prepare them for real
          gigs. Discouraged, they embark on a journey to gain the real-world
          experience needed for their success, often wondering why they paid so
        ...
        <h3 className={` ${styles.h3}`}>The Sound Roots Alternative</h3>
        <h4>Your curriculum, your pace</h4>
        <p className={styles.p}>
          I will meet you right where you are. I won't make you sit through
          lessons on topics you already know. I won't rush you through topics
          you might be struggling with in order to fit the program into a
          specific time period (like a semester). This is a tailor-made
          mentorship that's made for your goals on your schedule.
        </p>
        <p className={styles.p}>
          ...
          background, if any, and what your live audio goals are. We'll create a
          curriculum together that focuses on what you need to achieve your
          goals.
        </p>
        <h4>Real gear in real venues</h4>
        <p className={styles.p}>
          You won't be sitting in a classroom while I ramble at you, watching
          the clock and fighting sleep. We're going to be in real venues and
